...
# 🏃‍♂️ Formulario de Inscripción a la Maratón

Este repositorio contiene un **formulario simple de inscripción a una maratón**, desarrollado exclusivamente en **HTML**. Ideal para practicar estructuras de formularios web o integrarlo como parte de un sitio más grande.
